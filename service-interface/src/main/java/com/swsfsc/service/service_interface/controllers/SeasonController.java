...
public class SeasonController
{
	...
	public Collection<Season> getSeasons(@RequestHeader("ServiceCode") String service_code, @RequestHeader("Authorization") String auth_token) throws FirebaseAuthException
	{
	...
	public Collection<Season> getCurrentSeasons(@RequestHeader("ServiceCode") String service_code, @RequestHeader("Authorization") String auth_token) throws FirebaseAuthException
	{
		String uid = firebase.getUid(auth_token);
	...
	public Season createSeason(@RequestHeader("ServiceCode") String service_code, @RequestHeader("Authorization") String auth_token, @RequestBody Season season) throws FirebaseAuthException
	{
		String uid = firebase.getUid(auth_token);
